...
export default function Home() {
  ...
  return (
    <div>
      <Navbar />
      {/* As the carousal will not be reused in the future and also the search will be corelated to this file only so, making it as a new component will not be suitable */}
      <div
